...
import type {IErrorPage} from './error-page.type';

export const ErrorPage: React.FC<IErrorPage> = ({code, title, description, className, resetText, onReset}) => {
  return (
    <section className={clsx('flex justify-center items-center bg-white dark:bg-gray-900 h-screen', className)}>
