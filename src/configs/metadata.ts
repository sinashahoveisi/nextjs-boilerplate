...
export const METADATA: Metadata = {
  ...
  category: 'Technology, Gadgets, Business',
  keywords: ['Technology'],
  ...
  appleWebApp: {
    ...
    //   },
    //   {
    //     url: '/splash/iPhone_14__iPhone_13_Pro__iPhone_13__iPhone_12_Pro__iPhone_12_landscape.png',
    //     media:
